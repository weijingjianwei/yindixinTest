...
{
    if (port == GPIO_PORT_1){
        IOCTRLA_SFRS->GPIO1.HWMODE = (uint8_t)muxMode;
    }else if (port == GPIO_PORT_2){
        IOCTRLA_SFRS->GPIO2.HWMODE = (uint8_t)muxMode;
    }else if (port == GPIO_PORT_3){
        IOCTRLA_SFRS->GPIO3.HWMODE = (uint8_t)muxMode;
    }else{
        IOCTRLA_SFRS->GPIO4.HWMODE = (uint8_t)muxMode;
    }
  
  if (muxMode == GPIO_MUX_GPIO){
      if (port == GPIO_PORT_1){
          GPIO_SFRS->GPAP03.GPADIR0 = (uint8_t)stateMode;
          ...
          GPIO_SFRS->GPAP03.GPADIR1 = (uint8_t)stateMode;
          ...
          GPIO_SFRS->GPAP74.GPADIR4 = (uint8_t)stateMode;
          ...
          GPIO_SFRS->GPAP74.GPADIR5 = (uint8_t)stateMode;
      ...
      if (port == GPIO_PORT_1){
          IOCTRLA_SFRS->GPIO1.PWM_SEL = (uint8_t)channel;
      }else if (port == GPIO_PORT_2){
          IOCTRLA_SFRS->GPIO2.PWM_SEL = (uint8_t)channel;
      }else if (port == GPIO_PORT_3){
          IOCTRLA_SFRS->GPIO3.PWM_SEL = (uint8_t)channel;
      }else{
          IOCTRLA_SFRS->GPIO4.PWM_SEL = (uint8_t)channel;
      }
  }else{ /* GPIO_MUX_LIN */
...
{
    if (port == GPIO_PORT_1){
        GPIO_SFRS->GPAP03.GPARE0 = (uint8_t)risingEdge;
        GPIO_SFRS->GPAP03.GPAFE0 = (uint8_t)(!(bool)risingEdge);
        GPIO_SFRS->GPAP03.GPAIE0 = 1U;
    }else if (port == GPIO_PORT_2){
        GPIO_SFRS->GPAP03.GPARE1 = (uint8_t)risingEdge;
        GPIO_SFRS->GPAP03.GPAFE1 = (uint8_t)(!(bool)risingEdge);
        GPIO_SFRS->GPAP03.GPAIE1 = 1U;
    }else if (port == GPIO_PORT_3){
        GPIO_SFRS->GPAP74.GPARE4 = (uint8_t)risingEdge;
        GPIO_SFRS->GPAP74.GPAFE4 = (uint8_t)(!(bool)risingEdge);
        GPIO_SFRS->GPAP74.GPAIE4 = 1U;
    }else{
        GPIO_SFRS->GPAP74.GPARE5 = (uint8_t)risingEdge;
        GPIO_SFRS->GPAP74.GPAFE5 = (uint8_t)(!(bool)risingEdge);
...
{
    GPIO_SFRS->GPADATA[1U << (uint8_t)port] = ((uint8_t)state << (uint8_t)port);/* GPIO1 */
}
