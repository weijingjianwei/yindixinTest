 ...
 */
typedef struct{
    uint8_t LFRCSTS:  1; /*Slow oscillator status. Will be high when the 10KHz oscillator is selected*/
    uint8_t         : 7; 
    uint8_t         : 8; 
...
typedef struct {
    ...
    uint8_t           :  6;  /*    (reserved) */
    uint8_t SYSCLKSEL :  1; /*!< Clock select */
    uint8_t           :  7;  /*    (reserved) */
    uint8_t DIVSYSCLK :  2; /*!< Clock div select */
    uint8_t           :  6;
    uint8_t           :  8;  /*    (reserved) */
}SYSCLKCTRL_t;
...
typedef struct {
    ...
    uint8_t OVTEMPFLAG    :  1; /*!< Ovet Temp Violation flag */
    uint8_t               :  1; /*    (reserved) */
    ...
    uint8_t               :  7; /*    (reserved) */
    uint8_t SOFTRSTREQ    :  1; /*!< Soft reset request */
    uint8_t               :  7; /*    (reserved) */
} RESETCTRL_t;
...
*/
typedef struct {
    uint8_t BOR3V3THRESH       :  4; /*!< BOR 3v3 threshold */
    uint8_t                    :  4; /*    (reserved) */
    uint8_t                    :  8; /*    (reserved) */
    uint8_t BOR1V5THRESH       :  4; /*!< BOR 1v5 threshold */
    uint8_t                    :  4; /*    (reserved) */
...
*/
typedef struct {
    uint8_t KILLLFRC  :  1;/*Kill slow RC oscillator. Setting this bit gates the low frequency RC oscillator input*/
    uint8_t           :  7; /*    (reserved) */
    uint8_t           :  8; /*    (reserved) */
    uint16_t          : 16; /*    (reserved) */
}LFCLKKILL_t;
...
typedef struct {
    ...
    uint8_t               :  1; /*    (reserved) */
    uint8_t               :  8; /*    (reserved) */
    uint8_t TXLINCPSEL    :  1; /*!< TXLIN charge pump select */
    uint8_t TXLINCPREG    :  1; /*!< TXLIN charge pump override register */
    uint8_t               :  2; /*    (reserved) */
    uint8_t TXLINCPDIVSEL :  3; /*!< TxLIN charge pump divider select */
    uint8_t               :  1; /*    (reserved) */
    uint8_t               :  8; /*    (reserved) */
} CPCLKCTRL_t;
...
typedef struct {
    uint8_t OVTEMPLEVEL        :  4; /*!< Over Temp threshold */
    uint8_t                    :  4; /*    (reserved) */
    uint8_t                    :  8; /*    (reserved) */
    uint8_t                    :  8; /*    (reserved) */
    uint8_t OVTEMPENA          :  1; /*!< OverTemp Monitor Enable bit */
    uint8_t TEMP_SENSOR_DIS    :  1; /*!< temperature sensor disable bit */
    uint8_t                    :  6; /*    (reserved) */
}OVTEMPCONFIG_t;
